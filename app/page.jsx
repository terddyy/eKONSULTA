...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Navigation */}
      <nav className="bg-white shadow-sm border-b border-emerald-100 relative z-50">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-emerald-50 to-teal-50 py-10 sm:py-12 md:py-16 lg:py-20">
            ...
            <div className="px-0 sm:px-2 md:px-4">
              ...
              <div className="mt-6 sm:mt-8 flex flex-wrap items-center gap-y-2 gap-x-4 sm:gap-x-6 text-xs sm:text-sm text-gray-600">
                <div className="flex items-center">
                  <CheckCircle className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-emerald-500 mr-1.5 sm:mr-2" />
                  Free to use
                </div>
                <div className="flex items-center">
                  <CheckCircle className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-emerald-500 mr-1.5 sm:mr-2" />
      ...
      {/* Features Section */}
      <section id="features" className="py-12 sm:py-14 md:py-16 lg:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6 lg:gap-8">
            <Card className="border-0 shadow-md hover:shadow-lg sm:shadow-lg sm:hover:shadow-xl transition-shadow">
              <CardContent className="p-4 sm:p-5 md:p-6 lg:p-8 text-center">
                <div className="bg-emerald-100 w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-5 md:mb-6">
      ...
      <section id="how-it-works" className="py-12 sm:py-14 md:py-16 lg:py-20 bg-gradient-to-br from-emerald-50 to-teal-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-10 md:mb-12 lg:mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center bg-white p-4 sm:p-5 md:p-6 rounded-xl shadow-md">
              <div className="bg-emerald-600 text-white w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 text-lg sm:text-xl font-bold">
                1
              </div>
            ...
            <div className="text-center bg-white p-4 sm:p-5 md:p-6 rounded-xl shadow-md sm:col-span-2 md:col-span-1 sm:max-w-md md:max-w-none mx-auto sm:mx-auto md:mx-0">
              <div className="bg-emerald-600 text-white w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 text-lg sm:text-xl font-bold">
                3
              </div>
      ...
      {/* CTA Section */}
      <section className="py-12 sm:py-14 md:py-16 lg:py-20 bg-emerald-600">

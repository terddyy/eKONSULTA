          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/chat">
                  <Button size="lg" className="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold px-8 py-4 text-lg shadow-md">
      ...
      <section className="py-20 bg-emerald-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link href="/chat">
            <Button 
              size="lg" 
              className="bg-white hover:bg-gray-50 text-emerald-800 px-8 py-4 text-lg font-bold shadow-lg hover:shadow-xl transition-all transform hover:scale-105 rounded-xl border-4 border-emerald-500"
            >
              Start Free Consultation
